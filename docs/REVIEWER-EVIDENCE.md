...
| Canonical GraphQL query                                  | Runnable membership/detail queries and wallet-picker example in [`INTEGRATION.md`](./INTEGRATION.md)                                                    | Live and independently runnable                                                  |
...
| Community publication                                    | Ready-to-publish text in [`COMMUNITY-PROPOSAL.md`](./COMMUNITY-PROPOSAL.md)                                                                             | External publication pending approval                                            |
